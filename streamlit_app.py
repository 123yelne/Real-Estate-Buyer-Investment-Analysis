...
Single-file Streamlit App - Fixed for deployment
"""
...
if st.session_state.run_analysis:
    ...
    unique_countries = clients_df['country'].nunique()
    client_types = clients_df['client_type'].nunique()
    purposes = clients_df['acquisition_purpose'].nunique()
